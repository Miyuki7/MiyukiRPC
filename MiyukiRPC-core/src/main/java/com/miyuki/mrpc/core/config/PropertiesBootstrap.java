...
import static com.miyuki.mrpc.core.remoting.constants.RpcConstants.*;
...
public class PropertiesBootstrap {
    ...
    public static final String SERVER_PORT = "mrpc.serverPort";
    public static final String REGISTER_ADDRESS = "mrpc.registerAddr";
    public static final String REGISTER_TYPE = "mrpc.registerType";
    public static final String APPLICATION_NAME = "mrpc.applicationName";
    public static final String PROXY_TYPE = "mrpc.proxyType";
    public static final String ROUTER_TYPE = "mrpc.router";
    public static final String SERVER_SERIALIZE_TYPE = "mrpc.serverSerialize";
    public static final String CLIENT_SERIALIZE_TYPE = "mrpc.clientSerialize";
    public static final String CLIENT_DEFAULT_TIME_OUT = "mrpc.client.default.timeout";
    public static final String SERVER_BIZ_THREAD_NUMS = "mrpc.server.biz.thread.nums";
    public static final String SERVER_QUEUE_SIZE = "mrpc.server.queue.size";
    public static final String SERVER_MAX_CONNECTION = "mrpc.server.max.connection";
    public static final String SERVER_MAX_DATA_SIZE = "mrpc.server.max.data.size";
    public static final String CLIENT_MAX_DATA_SIZE = "mrpc.client.max.data.size";
